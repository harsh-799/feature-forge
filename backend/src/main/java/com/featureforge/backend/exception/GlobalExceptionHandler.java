...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleUserNotInWorkspaceException(UserNotInWorkspaceException ex) {
        ErrorDetails errorDetails = ErrorDetails.builder()
                .success(false)
                .message(ex.getMessage())
                .build();
    ...
    public ResponseEntity<ErrorDetails> handleCannotRemoveLastAdminException(CannotRemoveLastAdminException ex) {
        ErrorDetails errorDetails = ErrorDetails.builder()
                .success(false)
                .message(ex.getMessage())
                .build();
    ...
    @ExceptionHandler(CannotLeaveWorkspaceException.class)
    public ResponseEntity<ErrorDetails> handleCannotLeaveWorkspaceException(CannotLeaveWorkspaceException ex) {
        ErrorDetails errorDetails = ErrorDetails.builder()
                .success(false)
                .message(ex.getMessage())
                .build();
    ...
    @ExceptionHandler(FeatureInProductionException.class)
    public ResponseEntity<ErrorDetails> handleFeatureInProductionException(FeatureInProductionException ex) {
        ErrorDetails errorDetails = ErrorDetails.builder()
                .success(false)
                .message(ex.getMessage())
                .build();
    ...
    public ResponseEntity<ErrorDetails> handleWorkspaceInvitationNotFoundException(WorkspaceInvitationNotFoundException ex) {
        ErrorDetails errorDetails = ErrorDetails.builder()
                .success(false)
                .message(ex.getMessage())
                .build();
    ...
    public ResponseEntity<ErrorDetails> handleInvalidCurrentPasswordException(InvalidCurrentPasswordException ex) {
        ErrorDetails errorDetails = ErrorDetails.builder()
                .success(false)
                .message(ex.getMessage())
                .build();
