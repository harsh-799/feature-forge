 ...
 * Reused in headers, navbars, login panels, sidebar branding, footer, and empty states.
 */
 ...
 * Used only where there is enough space and where "FeatureForge" is not written separately.
 */
